        ...
        <div className="text-gray-300">
            ...
            <div className="space-y-4">
                <div className="p-4 bg-[#161616] rounded-lg border border-[#2c2c2c]">
                    ...
                    <div className="mt-3">
                        <div className="flex flex-wrap gap-2 mt-2">
                            {["Python", "Java", "JavaScript", "C", "C++", "Git", "Docker", "Virtual Machines", "Adobe Photoshop", "Premiere Pro", "After Effects", "Figma"].map((tech) => (
                ...
                <div className="p-4 bg-[#161616] rounded-lg border border-[#2c2c2c]">
                    ...
                    <div className="mt-3">
                        <div className="flex flex-wrap gap-2 mt-2">
                            {["Flask", "Django", "React", "TailwindCSS", "REST APIs", "Unit Testing", "CI/CD pipelines"].map((tech) => (
                                <span key={tech} className="px-2 py-1 text-xs bg-[#2c2c2c] rounded-md">
                                    {tech}
                                </span>
                            ))}
                        ...
                        <div className="space-y-2">
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2 mt-1">
                                    {["AWS", "Google Cloud", "Microsoft Azure", "PostgreSQL", "MongoDB", "MySQL", "MariaDB"].map((tech) => (
                                        <span key={tech} className="px-2 py-1 text-xs bg-[#2c2c2c] rounded-md">
                                            {tech}
                                        </span>
                                    ))}
